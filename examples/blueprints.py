...
class Todo(Resource):
    ...
    def get(self, todo_id):
        ...
        """Get a todo task.
        Source: https://github.com/rantav/flask-restful-swagger/blob/master/examples/blueprints.py#L86
    ...
    def delete(self, todo_id):
        """Delete a todo task.
        Source: https://github.com/rantav/flask-restful-swagger/blob/master/examples/blueprints.py#L105
        """
        abort_if_todo_doesnt_exist(todo_id)
        del TODOS[todo_id]
    ...
    def put(self, todo_id):
        """Update a todo task.
        Source: https://github.com/rantav/flask-restful-swagger/blob/master/examples/blueprints.py#L115
        """
...
class TodoList(Resource):
    def get(self):
        """ Get all the todos.
        Source: https://github.com/rantav/flask-restful-swagger/blob/master/examples/blueprints.py#L137
        """
    ...
    def post(self):
        """Create a new todo.
        Source: https://github.com/rantav/flask-restful-swagger/blob/master/examples/blueprints.py#L163
        """
        args = parser.parse_args()
